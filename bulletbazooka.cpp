...
BulletBazooka::BulletBazooka(float _speed, int _width, int _height,int _damage, float _aimX, float _aimY, float _startX, float _startY, int _range)
...
//range nie obowiazuje
void BulletBazooka::checkField(Board *_map)
{
